...
<template>
    <view class="box f_r_c" v-if="custStatus == -3 || custStatus == -2 || custStatus == -1 || custStatus == 0 || custStatus == 7">
        ...
        <view class="one_box f_c_s">
            <view class="line_no"></view>
            <image mode="widthFix" class="status_img_no" :src="noStatusImgList"></image>
            <text class="no_status_text">带看</text>
        </view>
        <view class="one_box f_c_s">
            <view class="line_no"></view>
            <image mode="widthFix" class="status_img_no" :src="noStatusImgList"></image>
    ...
    <view class="box f_r_c" v-else>
        <view class="one_box f_c_s">
          <view class="line_yes" v-if="custStatus>=3"></view>
          <view class="line_no" v-else></view>
          <image mode="widthFix" class="status_img_yes" :src="hasStatusImgList" v-if="custStatus>=2"></image>
          <image mode="widthFix" class="status_img_no" :src="noStatusImgList" v-else></image>
          <text class="is_status_text" v-if="custStatus>=2">报备</text>
        ...
        <view class="one_box f_c_s">
          ...
          <image mode="widthFix" class="status_img_no" :src="noStatusImgList" v-else></image>
          <text class="is_status_text" v-if="custStatus>=3">带看</text>
          <text class="no_status_text" v-else>带看</text>
      </view>
        <view class="one_box f_c_s">
        ...
        <view class="one_box f_c_s">
          <view class="line_yes" v-if="custStatus>=6"></view>
          <view class="line_no" v-else></view>
        ...
        <view class="one_box f_c_s">
          <view class="line_none"></view>
          <image mode="widthFix" class="status_img_yes" :src="hasStatusImgList" v-if="custStatus>=6"></image>
          <image mode="widthFix" class="status_img_no" :src="noStatusImgList" v-else></image>
          <text class="is_status_text" v-if="custStatus>=6">结佣</text>
          <text class="no_status_text" v-else>结佣</text>
      </view>

        <!--已结佣icon-->
        <image class="status_icon" v-if="custStatus==6" mode="widthFix" :src="icons[6]"></image>
    </view>
</template>
        ...
        data(){
            return{
                icons:{
                    ...
                    '7':'http://cdn.haofang.net/static/xffx-uniapp/customer/yituiyong.png',
                },
